...
QT_MOC_LITERAL(5, 39, 6), // "passwd"
QT_MOC_LITERAL(6, 46, 11), // "fa_register"
QT_MOC_LITERAL(7, 58, 4), // "name"
QT_MOC_LITERAL(8, 63, 7) // "fa_back"

    },
    "wid_login\0fa_login\0emit\0account\0string\0"
    "passwd\0fa_register\0name\0fa_back"
};
...
void wid_login::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->fa_login((*reinterpret_cast< long long(*)>(_a[1])),(*reinterpret_cast< string(*)>(_a[2]))); break;
        case 1: _t->fa_register((*reinterpret_cast< string(*)>(_a[1])),(*reinterpret_cast< string(*)>(_a[2]))); break;
        ...
        {
            using _t = void (wid_login::*)(long long , string );
        ...
        {
            using _t = void (wid_login::*)(string , string );
...
// SIGNAL 0
void wid_login::fa_login(long long _t1, string _t2)
{
...
// SIGNAL 1
void wid_login::fa_register(string _t1, string _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))), const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t2))) };
